...
function main()
{
	...
	//var shaderSourceVS = document.getElementById("vertex-shader").textContent;
	//var vertexShader = loadShader(gl, gl.VERTEX_SHADER, shaderSourceVS);
//
	//var shaderSourceFS = document.getElementById("fragment-shader").textContent;
	//var fragmentShader = loadShader(gl, gl.FRAGMENT_SHADER, shaderSourceFS);
//
